  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-300 mt-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:aklilumengesha57@gmail.com" className="hover:text-blue-400 transition-colors">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+251998121942" className="hover:text-blue-400 transition-colors">
                  +251 99 812 1942
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="container mx-auto px-8 py-6">
          <div className="flex flex-col items-center gap-3">
            <p className="text-gray-400 text-sm text-center">
              © 2026 eShop. All rights reserved. | Developed by{' '}
              <a 
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-full shadow-lg transition-all hover:scale-110 z-50 animate-fadeIn"
